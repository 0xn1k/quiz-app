    ...
    <footer className="bg-slate-900 text-slate-300 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          {/* Company Info */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">🎯 Quiz App</h3>
            <p className="text-sm text-slate-400 leading-relaxed mb-4">
              Your ultimate exam preparation platform. Practice, learn, and excel with thousands of questions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/questions" className="text-sm hover:text-white transition-colors">Question Bank</Link></li>
              <li><Link href="/quiz" className="text-sm hover:text-white transition-colors">Take Quiz</Link></li>
              <li><Link href="/tests" className="text-sm hover:text-white transition-colors">Mock Tests</Link></li>
              <li><Link href="/analytics" className="text-sm hover:text-white transition-colors">Analytics</Link></li>
